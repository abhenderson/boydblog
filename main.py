...
# %% auto 0
__all__ = ['nbpaths', 'app', 'rt', 'thishost', 'runningserver', 'host', 'get_nb_paths', 'get_title_and_desc', 'NBLink',
           'mk_nblink_from_nbpath', 'get_date_from_iso8601_prefix', 'NBCard', 'mk_nbcard_from_nb_path', 'InLi',
           'InlineNav', 'index', 'about', 'StyledCode', 'MonsterHtmlRenderer', 'StyledMd', 'StyledCell', 'notebook',
           'versions', 'wellknown']
...
# %% nbs/2025-03-19-ComputerProjectBlogCode.ipynb 8
nbpaths = get_nb_paths()
nbpaths

# %% nbs/2025-03-19-ComputerProjectBlogCode.ipynb 11
...
# %% nbs/2025-03-19-ComputerProjectBlogCode.ipynb 17
def get_nb_paths(): 
    root = Path() if IN_NOTEBOOK else Path("nbs/")
    return L(root.glob("*.ipynb")).sorted(reverse=True)
...
# %% nbs/2025-03-19-ComputerProjectBlogCode.ipynb 21
...
# %% nbs/2025-03-19-ComputerProjectBlogCode.ipynb 22
...
# %% nbs/2025-03-19-ComputerProjectBlogCode.ipynb 23
...
# %% nbs/2025-03-19-ComputerProjectBlogCode.ipynb 31
def InlineNav():
    nls = L(
...
# %% nbs/2025-03-19-ComputerProjectBlogCode.ipynb 38
...
# %% nbs/2025-03-19-ComputerProjectBlogCode.ipynb 40
def StyledMd(m):
